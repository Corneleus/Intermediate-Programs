...
public class Sorts
{
	...
	public static void main(String[] args)
	{
		...
		selectionSort();
		System.out.printf("\nNumber of swaps in Selection Sort: %d ", swaps);
		System.out.printf("\nNumber of comparasins in Selection Sort: %d ", comps);
		...
		zeroOut();
		bubbleSort();
		System.out.printf("\nNumber of swaps in Bubble Sort: %d ", swaps);
		System.out.printf("\nNumber of comparasins in Bubble Sort: %d ", comps);

		System.out.println();

		initValues();
		shortBubble();
		System.out.printf("\nNumber of swaps in Short Bubble Sort: %d ", swaps);
		System.out.printf("\nNumber of comparasins in Short Bubble Sort: %d ", comps);

		System.out.println();

		initValues();
		insertionSort();
		System.out.printf("\nNumber of swaps in Insertion sort: %d ", swaps);
		System.out.printf("\nNumber of comparasins in Insertion sort: %d ", comps);
		...
		zeroOut();
		mergeSort(0, SIZE - 1);
		System.out.printf("\nNumber of swaps in Merge sort: %d ", swaps);
		System.out.printf("\nNumber of comparasins in Merge sort: %d ", comps);
		...
		zeroOut();
		quickSort(0, SIZE - 1);
		System.out.printf("\nNumber of swaps in Quick sort: %d ", swaps);
		System.out.printf("\nNumber of comparasins in Quick sort: %d ", comps);
		...
		zeroOut();
		heapSort();
		System.out.printf("\nNumber of swaps in Heap sort: %d ", swaps);
		System.out.printf("\nNumber of comparasins in Heap sort: %d ", comps);
